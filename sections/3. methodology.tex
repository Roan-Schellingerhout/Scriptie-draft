...
% - 20 vids per bot
% - videos under an hour long
% - no livestreams

% --> maybe smart: rather than having completely random starting vids for 3 and 4, filter them first. 
...
\begin{algorithm}[H]
 ...
 \For{twenty videos}{
  \eIf{there is a recommendation to be watched}{
    ...
    pick a video to watch based on usertype\;
